...
import io.github.xiaodizi.cql3.functions.types.UserType;
...
public class CQLSSTableWriter implements Closeable
{
    ...
    public UserType getUDType(String dataType)
    {
        ...
        io.github.xiaodizi.db.marshal.UserType userType = ksm.types.getNullable(ByteBufferUtil.bytes(dataType));
