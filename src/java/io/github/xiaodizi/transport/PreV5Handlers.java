...
import io.github.xiaodizi.transport.ClientResourceLimits.Overload;
...
import io.github.xiaodizi.transport.messages.ErrorMessage;
import io.github.xiaodizi.utils.JVMStabilityInspector;

import static io.github.xiaodizi.transport.CQLMessageHandler.RATE_LIMITER_DELAY_UNIT;
import static io.github.xiaodizi.transport.ClientResourceLimits.GLOBAL_REQUEST_LIMITER;

public class PreV5Handlers
{
    /**
     * Wraps an {@link io.github.xiaodizi.transport.Dispatcher} so that it can be used as an
    ...
    /**
     * Simple adaptor to allow {@link io.github.xiaodizi.transport.Message.Decoder#decodeMessage(Channel, Envelope)}
    ...
    /**
     * Pre-V5 exception handler which closes the connection if an {@link io.github.xiaodizi.transport.ProtocolException}
     * is thrown
     */
    @ChannelHandler.Sharable
