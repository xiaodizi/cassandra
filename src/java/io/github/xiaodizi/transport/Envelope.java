...
public class Envelope
{
    ...
    public static class Decoder extends ByteToMessageDecoder
    {
         ...
         *  off the wire happens at the layer below, in {@link io.github.xiaodizi.net.FrameDecoder}</li>
    ...
    public static class Decompressor extends MessageToMessageDecoder<Envelope>
    {
        ...
        throws IOException
        {
            ...
            io.github.xiaodizi.transport.Compressor compressor = connection.getCompressor();
            if (compressor == null)
            {
                results.add(source);
                return;
