...
import io.github.xiaodizi.utils.ExpiringMemoizingSupplier;
...
import io.github.xiaodizi.utils.RecomputingSupplier;
import io.github.xiaodizi.utils.concurrent.UncheckedInterruptedException;
import io.github.xiaodizi.utils.concurrent.NotScheduledFuture;

import static io.github.xiaodizi.concurrent.ExecutorFactory.Global.executorFactory;
import static io.github.xiaodizi.config.CassandraRelevantProperties.DISABLE_GOSSIP_ENDPOINT_REMOVAL;
import static io.github.xiaodizi.config.CassandraRelevantProperties.GOSSIPER_QUARANTINE_DELAY;
import static io.github.xiaodizi.config.CassandraRelevantProperties.GOSSIPER_SKIP_WAITING_TO_SETTLE;
import static io.github.xiaodizi.config.CassandraRelevantProperties.SHUTDOWN_ANNOUNCE_DELAY_IN_MS;
import static io.github.xiaodizi.config.DatabaseDescriptor.getClusterName;
import static io.github.xiaodizi.config.DatabaseDescriptor.getPartitionerName;
...
{
    public static final String MBEAN_NAME = "io.github.xiaodizi.net:type=Gossiper";
