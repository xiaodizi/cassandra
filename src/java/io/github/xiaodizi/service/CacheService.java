...
import io.github.xiaodizi.cache.*;
import io.github.xiaodizi.cache.AutoSavingCache.CacheSerializer;
...
import io.github.xiaodizi.db.context.CounterContext;
import io.github.xiaodizi.db.filter.*;
import io.github.xiaodizi.db.lifecycle.SSTableSet;
import io.github.xiaodizi.db.partitions.CachedBTreePartition;
...
public class CacheService implements CacheServiceMBean
{
    ...
    public static final String MBEAN_NAME = "io.github.xiaodizi.db:type=Caches";
    ...
    private AutoSavingCache<RowCacheKey, IRowCacheEntry> initRowCache()
    {
        ...
        String cacheProviderClassName = DatabaseDescriptor.getRowCacheSizeInMiB() > 0
                                        ? DatabaseDescriptor.getRowCacheClassName() : "io.github.xiaodizi.cache.NopCacheProvider";
        try
        {
