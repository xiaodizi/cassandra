 ...
 *
 * Useful for {@link io.github.xiaodizi.hints.HintsReader}, for example, where we must verify the CRC, yet don't want
 ...
 * so that {@link io.github.xiaodizi.db.Mutation.MutationSerializer} doesn't blow up the heap when deserializing a
 * corrupted sequence by reading a huge corrupted length of bytes via
 * {@link io.github.xiaodizi.utils.ByteBufferUtil#readWithLength(java.io.DataInput)}.
 */
