 ...
 *
 * This used to happen, for example, in {@link io.github.xiaodizi.db.ReadCommand#executeLocally(ReadExecutionController)}
 * if {@link io.github.xiaodizi.db.filter.DataLimits} stopped the iterator on a live row that was enclosed in an
 * older RT.
 *
