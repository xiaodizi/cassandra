...
{
    public static final String DEPRECATED_MBEAN_NAME = "io.github.xiaodizi.db:type=BlacklistedDirectories";
    public static final String MBEAN_NAME = "io.github.xiaodizi.db:type=DisallowedDirectories";
