...
import static io.github.xiaodizi.db.rows.UnfilteredRowIteratorSerializer.IS_EMPTY;
...
public class PartitionUpdate extends AbstractBTreePartition
{
     ...
     *
     * @throws io.github.xiaodizi.serializers.MarshalException if some of the data contained in this update is corrupted.
     */
