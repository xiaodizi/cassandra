...
public interface CachedPartition extends Partition, IRowCacheEntry
{
     ...
     *
     * See {@link io.github.xiaodizi.db.ColumnFamilyStore#isFilterFullyCoveredBy} to see why we need this.
     *
     ...
     * {@link io.github.xiaodizi.db.filter.DataLimits#hasEnoughLiveData} as an optimization.
     *
