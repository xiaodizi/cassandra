...
import io.github.xiaodizi.db.transform.RTBoundCloser;
import io.github.xiaodizi.db.transform.RTBoundValidator;
import io.github.xiaodizi.db.transform.RTBoundValidator.Stage;
import io.github.xiaodizi.db.transform.StoppingTransformation;
import io.github.xiaodizi.db.transform.Transformation;
import io.github.xiaodizi.exceptions.UnknownIndexException;
import io.github.xiaodizi.index.Index;
import io.github.xiaodizi.index.IndexNotAvailableException;
...
import static io.github.xiaodizi.db.partitions.UnfilteredPartitionIterators.MergeListener.NOOP;
...
public abstract class ReadCommand extends AbstractReadQuery
{
    ...
    protected class CheckForAbort extends StoppingTransformation<UnfilteredRowIterator>
    {
        ...
        private boolean maybeAbort()
        {
             ...
             * {@link io.github.xiaodizi.utils.MonotonicClock.SampledClock.CHECK_INTERVAL_MS}, by default 2 millis. Since MonitorableImpl
