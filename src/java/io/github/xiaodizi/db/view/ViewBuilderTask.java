...
package io.github.xiaodizi.db.view;
...
import io.github.xiaodizi.db.compaction.CompactionInfo.Unit;
...
public class ViewBuilderTask extends CompactionInfo.Holder implements Callable<Long>
{
    ...
    public Long call()
    {
        ...
        Function<io.github.xiaodizi.db.lifecycle.View, Iterable<SSTableReader>> function;
        function = io.github.xiaodizi.db.lifecycle.View.select(SSTableSet.CANONICAL, s -> range.intersects(s.getBounds()));
