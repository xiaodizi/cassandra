...
public class ExpirationDateOverflowHandling
{
        ...
        if (ttl + nowInSecs < 0)
        {
            switch (policy)
            {
                ...
                case CAP_NOWARN:
                     ...
                     * to {@link io.github.xiaodizi.db.BufferExpiringCell#MAX_DELETION_TIME}
                     */
     ...
     * during {@link ExpirationDateOverflowHandling#maybeApplyExpirationDateOverflowPolicy(io.github.xiaodizi.schema.TableMetadata, int, boolean)},
