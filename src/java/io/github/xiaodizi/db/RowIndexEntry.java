...
import io.github.xiaodizi.cache.IMeasurableMemory;
import io.github.xiaodizi.config.DataStorageSpec;
import io.github.xiaodizi.config.DatabaseDescriptor;
import io.github.xiaodizi.db.filter.RowIndexEntryReadSizeTooLargeException;
import io.github.xiaodizi.io.ISerializer;
import io.github.xiaodizi.io.sstable.IndexInfo;
...
import io.github.xiaodizi.io.util.FileDataInput;
import io.github.xiaodizi.io.util.FileHandle;
import io.github.xiaodizi.io.util.RandomAccessReader;
import io.github.xiaodizi.io.util.TrackedDataInputPlus;
...
import static io.github.xiaodizi.metrics.CassandraMetricsRegistry.Metrics;
 ...
 *     by {@link io.github.xiaodizi.config.Config#column_index_size}.
 * </p>
 * <p>
 ...
 *     {@link io.github.xiaodizi.config.Config#column_index_cache_size}.
 ...
 *     {@link io.github.xiaodizi.config.Config#column_index_cache_size}.</li>
 *     <li>{@link ShallowIndexedEntry} is for index entries with index samples
 *     that exceed {@link io.github.xiaodizi.config.Config#column_index_cache_size}
 ...
 *     i.e. sstables created by Cassandra &lt; 3.0 (see {@link io.github.xiaodizi.io.sstable.format.big.BigFormat}.
 * </p>
 *
 */
public class RowIndexEntry<T> implements IMeasurableMemory
{
    ...
    /**
     * @param dataFilePosition  position of the partition in the {@link io.github.xiaodizi.io.sstable.Component.Type#DATA} file
     * @param indexFilePosition position in the {@link io.github.xiaodizi.io.sstable.Component.Type#PRIMARY_INDEX} of the {@link RowIndexEntry}
     ...
     * @param indexSamples      list with IndexInfo offsets (if total serialized size is less than {@link io.github.xiaodizi.config.Config#column_index_cache_size}
    ...
    private static final class IndexedEntry extends RowIndexEntry<IndexInfo>
    {
        ...
        /**
         * Constructor called from {@link Serializer#deserializeForCache(io.github.xiaodizi.io.util.DataInputPlus)}.
         */
