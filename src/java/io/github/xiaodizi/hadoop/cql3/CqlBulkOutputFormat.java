 ...
 */
package io.github.xiaodizi.hadoop.cql3;
...
import io.github.xiaodizi.hadoop.ConfigHelper;
import io.github.xiaodizi.hadoop.HadoopCompat;
 ...
 *
 * <p>
 * As is the case with the {@link io.github.xiaodizi.hadoop.cql3.CqlOutputFormat},
 * you need to set the prepared statement in your
 * Hadoop job Configuration. The {@link CqlConfigHelper} class, through its
 * {@link io.github.xiaodizi.hadoop.ConfigHelper#setOutputPreparedStatement} method, is provided to make this
 * simple.
 * you need to set the Keyspace. The {@link ConfigHelper} class, through its
 * {@link io.github.xiaodizi.hadoop.ConfigHelper#setOutputColumnFamily} method, is provided to make this
 * simple.
 * </p>
 */
