...
import static io.github.xiaodizi.tools.Util.BLUE;
import static io.github.xiaodizi.tools.Util.CYAN;
import static io.github.xiaodizi.tools.Util.RESET;
import static io.github.xiaodizi.tools.Util.WHITE;
...
import io.github.xiaodizi.io.sstable.IndexSummary;
import io.github.xiaodizi.io.sstable.format.SSTableReader;
import io.github.xiaodizi.io.sstable.metadata.CompactionMetadata;
...
import io.github.xiaodizi.tools.Util.TermHistogram;
                    ...
                    while (partition.hasNext())
                    {
                        ...
                        switch (unfiltered.kind())
                        {
                            case ROW:
                                ...
                                psize += row.dataSize();
                                pcount++;
                                for (io.github.xiaodizi.db.rows.Cell<?> cell : row.cells())
                                {
                                    cellCount++;
