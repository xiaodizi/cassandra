 ...
 */
package io.github.xiaodizi.tools;
...
import io.github.xiaodizi.audit.AuditLogManager;
import io.github.xiaodizi.audit.AuditLogManagerMBean;
import io.github.xiaodizi.audit.AuditLogOptions;
import io.github.xiaodizi.audit.AuditLogOptionsCompositeData;
import com.google.common.collect.ImmutableMap;
import io.github.xiaodizi.auth.AuthCache;
import io.github.xiaodizi.auth.AuthCacheMBean;
import io.github.xiaodizi.auth.NetworkPermissionsCache;
import io.github.xiaodizi.auth.NetworkPermissionsCacheMBean;
import io.github.xiaodizi.auth.PasswordAuthenticator;
import io.github.xiaodizi.auth.PermissionsCache;
import io.github.xiaodizi.auth.PermissionsCacheMBean;
import io.github.xiaodizi.auth.RolesCache;
import io.github.xiaodizi.auth.RolesCacheMBean;
import io.github.xiaodizi.auth.jmx.AuthorizationProxy;
import io.github.xiaodizi.batchlog.BatchlogManager;
import io.github.xiaodizi.batchlog.BatchlogManagerMBean;
import io.github.xiaodizi.db.ColumnFamilyStoreMBean;
import io.github.xiaodizi.db.compaction.CompactionManager;
import io.github.xiaodizi.db.compaction.CompactionManagerMBean;
import io.github.xiaodizi.fql.FullQueryLoggerOptions;
import io.github.xiaodizi.fql.FullQueryLoggerOptionsCompositeData;
...
import io.github.xiaodizi.gms.GossiperMBean;
import io.github.xiaodizi.hints.HintsService;
import io.github.xiaodizi.hints.HintsServiceMBean;
...
import io.github.xiaodizi.metrics.StorageMetrics;
import io.github.xiaodizi.metrics.TableMetrics;
import io.github.xiaodizi.metrics.ThreadPoolMetrics;
import io.github.xiaodizi.net.MessagingService;
import io.github.xiaodizi.net.MessagingServiceMBean;
import io.github.xiaodizi.service.ActiveRepairServiceMBean;
import io.github.xiaodizi.service.CacheService;
import io.github.xiaodizi.service.CacheServiceMBean;
import io.github.xiaodizi.service.GCInspector;
import io.github.xiaodizi.service.GCInspectorMXBean;
import io.github.xiaodizi.service.StorageProxy;
import io.github.xiaodizi.service.StorageProxyMBean;
import io.github.xiaodizi.service.StorageServiceMBean;
import io.github.xiaodizi.streaming.StreamManagerMBean;
import io.github.xiaodizi.streaming.StreamState;
import io.github.xiaodizi.streaming.management.StreamStateCompositeData;
...
import io.github.xiaodizi.tools.nodetool.GetTimeout;
import io.github.xiaodizi.utils.NativeLibrary;
...
public class NodeProbe implements AutoCloseable
{
    ...
    private static final String ssObjName = "io.github.xiaodizi.db:type=StorageService";
    ...
    {
        String cachePath = "io.github.xiaodizi.db:type=Caches";
    ...
    public EndpointSnitchInfoMBean getEndpointSnitchInfoProxy()
    {
        try
        {
            return JMX.newMBeanProxy(mbeanServerConn, new ObjectName("io.github.xiaodizi.db:type=EndpointSnitchInfo"), EndpointSnitchInfoMBean.class);
        }
        catch (MalformedObjectNameException e)
        {
            throw new RuntimeException(e);
    ...
    public DynamicEndpointSnitchMBean getDynamicEndpointSnitchInfoProxy()
    {
        try
        {
            return JMX.newMBeanProxy(mbeanServerConn, new ObjectName("io.github.xiaodizi.db:type=DynamicEndpointSnitch"), DynamicEndpointSnitchMBean.class);
        }
        catch (MalformedObjectNameException e)
        {
            throw new RuntimeException(e);
    ...
    public ColumnFamilyStoreMBean getCfsProxy(String ks, String cf)
    {
        ...
        try
        {
            ...
            Set<ObjectName> beans = mbeanServerConn.queryNames(
                    new ObjectName("io.github.xiaodizi.db:type=*" + type +",keyspace=" + ks + ",columnfamily=" + cf), null);
            ...
            switch(metricName)
            {
                ...
                case "Size":
                    return JMX.newMBeanProxy(mbeanServerConn,
                            new ObjectName("io.github.xiaodizi.metrics:type=Cache,scope=" + cacheType + ",name=" + metricName),
                ...
                case "MissLatencyUnit":
                    return JMX.newMBeanProxy(mbeanServerConn,
                            new ObjectName("io.github.xiaodizi.metrics:type=Cache,scope=" + cacheType + ",name=MissLatency"),
    ...
    private static Multimap<String, String> getJmxThreadPools(MBeanServerConnection mbeanServerConn)
    {
        try
        {
            ...
            Set<ObjectName> threadPoolObjectNames = mbeanServerConn.queryNames(
                    new ObjectName("io.github.xiaodizi.metrics:type=ThreadPools,*"),
                    null);
    ...
    {
      String name = String.format("io.github.xiaodizi.metrics:type=ThreadPools,path=%s,scope=%s,name=%s",
    ...
    public Object getColumnFamilyMetric(String ks, String cf, String metricName)
    {
        try
        {
            ...
            if (!Strings.isNullOrEmpty(ks) && !Strings.isNullOrEmpty(cf))
            {
                ...
                oName = new ObjectName(String.format("io.github.xiaodizi.metrics:type=%s,keyspace=%s,scope=%s,name=%s", type, ks, cf, metricName));
            }
            else if (!Strings.isNullOrEmpty(ks))
            {
                oName = new ObjectName(String.format("io.github.xiaodizi.metrics:type=Keyspace,keyspace=%s,name=%s", ks, metricName));
            }
            else
            {
                oName = new ObjectName(String.format("io.github.xiaodizi.metrics:type=Table,name=%s", metricName));
            }
            switch(metricName)
            {
    ...
    public CassandraMetricsRegistry.JmxTimerMBean getProxyMetric(String scope)
    {
        ...
        {
            return JMX.newMBeanProxy(mbeanServerConn,
                    new ObjectName("io.github.xiaodizi.metrics:type=ClientRequest,scope=" + scope + ",name=Latency"),
    ...
    public CassandraMetricsRegistry.JmxTimerMBean getMessagingQueueWaitMetrics(String verb)
    {
        ...
        {
            return JMX.newMBeanProxy(mbeanServerConn,
                                     new ObjectName("io.github.xiaodizi.metrics:name=" + verb + "-WaitLatency,type=Messaging"),
                                     CassandraMetricsRegistry.JmxTimerMBean.class);
        }
        catch (MalformedObjectNameException e)
        {
    ...
    public Object getCompactionMetric(String metricName)
    {
        try
        {
            switch(metricName)
            {
                case "BytesCompacted":
                    return JMX.newMBeanProxy(mbeanServerConn,
                            new ObjectName("io.github.xiaodizi.metrics:type=Compaction,name=" + metricName),
        ...
        try
        {
            switch(metricName)
            {
                ...
                case "clientsByProtocolVersion": // number of native clients by username
                    return JMX.newMBeanProxy(mbeanServerConn,
                            new ObjectName("io.github.xiaodizi.metrics:type=Client,name=" + metricName),
                            CassandraMetricsRegistry.JmxGaugeMBean.class).getValue();
                default:
    ...
    public long getStorageMetric(String metricName)
    {
        ...
        {
            return JMX.newMBeanProxy(mbeanServerConn,
                    new ObjectName("io.github.xiaodizi.metrics:type=Storage,name=" + metricName),
...
class ColumnFamilyStoreMBeanIterator implements Iterator<Map.Entry<String, ColumnFamilyStoreMBean>>
{
    ...
    {
        ObjectName query = new ObjectName("io.github.xiaodizi.db:type=" + type +",*");
