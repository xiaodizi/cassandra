 ...
 */
package io.github.xiaodizi.locator;
...
import io.github.xiaodizi.dht.RingPosition;
...
import io.github.xiaodizi.service.DatacenterSyncWriteResponseHandler;
import io.github.xiaodizi.service.DatacenterWriteResponseHandler;
import io.github.xiaodizi.service.WriteResponseHandler;
...
public abstract class AbstractReplicationStrategy
{
     ...
     * "primary" range in
     * {@link io.github.xiaodizi.service.StorageService#getPrimaryRangesForEndpoint(String, InetAddressAndPort)}
     * which is in turn relied on by various components like repair and size estimate calculations.
     *
     * @see #getNaturalReplicasForToken(io.github.xiaodizi.dht.RingPosition)
     *
     ...
     * map is already immutable and comes from {@link io.github.xiaodizi.schema.ReplicationParams}
    ...
    {
        String className = cls.contains(".") ? cls : "io.github.xiaodizi.locator." + cls;

        if ("io.github.xiaodizi.locator.OldNetworkTopologyStrategy".equals(className)) // see CASSANDRA-16301 
