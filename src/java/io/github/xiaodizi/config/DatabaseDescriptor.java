...
import io.github.xiaodizi.auth.AllowAllInternodeAuthenticator;
import io.github.xiaodizi.auth.AuthConfig;
import io.github.xiaodizi.auth.IAuthenticator;
import io.github.xiaodizi.auth.IAuthorizer;
import io.github.xiaodizi.auth.IInternodeAuthenticator;
import io.github.xiaodizi.auth.INetworkAuthorizer;
import io.github.xiaodizi.auth.IRoleManager;
import io.github.xiaodizi.config.Config.CommitLogSync;
import io.github.xiaodizi.config.Config.PaxosOnLinearizabilityViolation;
import io.github.xiaodizi.config.Config.PaxosStatePurging;
import io.github.xiaodizi.db.ConsistencyLevel;
import io.github.xiaodizi.db.commitlog.AbstractCommitLogSegmentManager;
import io.github.xiaodizi.db.commitlog.CommitLog;
import io.github.xiaodizi.db.commitlog.CommitLogSegmentManagerCDC;
import io.github.xiaodizi.db.commitlog.CommitLogSegmentManagerStandard;
...
import io.github.xiaodizi.io.util.DiskOptimizationStrategy;
...
import io.github.xiaodizi.io.util.SpinningDiskOptimizationStrategy;
import io.github.xiaodizi.io.util.SsdDiskOptimizationStrategy;
import io.github.xiaodizi.locator.DynamicEndpointSnitch;
...
import io.github.xiaodizi.locator.SeedProvider;
import io.github.xiaodizi.security.EncryptionContext;
import io.github.xiaodizi.security.SSLFactory;
import io.github.xiaodizi.service.CacheService.CacheType;
import io.github.xiaodizi.service.paxos.Paxos;
import io.github.xiaodizi.utils.FBUtilities;

import static io.github.xiaodizi.config.CassandraRelevantProperties.OS_ARCH;
import static io.github.xiaodizi.config.CassandraRelevantProperties.SUN_ARCH_DATA_MODEL;
import static io.github.xiaodizi.config.CassandraRelevantProperties.TEST_JVM_DTEST_DISABLE_SSL;
import static io.github.xiaodizi.config.DataRateSpec.DataRateUnit.BYTES_PER_SECOND;
import static io.github.xiaodizi.config.DataRateSpec.DataRateUnit.MEBIBYTES_PER_SECOND;
import static io.github.xiaodizi.config.DataStorageSpec.DataStorageUnit.MEBIBYTES;
import static io.github.xiaodizi.io.util.FileUtils.ONE_GIB;
import static io.github.xiaodizi.io.util.FileUtils.ONE_MIB;
import static io.github.xiaodizi.utils.Clock.Global.logInitializationOutcome;
...
public class DatabaseDescriptor
{
    ...
    public static IEndpointSnitch createEndpointSnitch(boolean dynamic, String snitchClassName) throws ConfigurationException
    {
        if (!snitchClassName.contains("."))
            snitchClassName = "io.github.xiaodizi.locator." + snitchClassName;
    ...
    private static IFailureDetector createFailureDetector(String detectorClassName) throws ConfigurationException
    {
        if (!detectorClassName.contains("."))
            detectorClassName = "io.github.xiaodizi.gms." + detectorClassName;
