...
import io.github.xiaodizi.concurrent.ResizableThreadPool;
import io.github.xiaodizi.metrics.CassandraMetricsRegistry.MetricName;
...
public class ThreadPoolMetrics
{
    ...
    {
        return new MetricName("io.github.xiaodizi.metrics",
                              "ThreadPools",
                              metricName,
                              path + '.' + poolName,
                              format("io.github.xiaodizi.metrics:type=ThreadPools,path=%s,scope=%s,name=%s",
