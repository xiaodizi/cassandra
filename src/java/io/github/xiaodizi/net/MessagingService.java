...
import io.github.xiaodizi.utils.concurrent.AsyncPromise;
...
import io.github.xiaodizi.metrics.MessagingMetrics;
import io.github.xiaodizi.service.AbstractWriteResponseHandler;
import io.github.xiaodizi.utils.ExecutorUtils;
import io.github.xiaodizi.utils.FBUtilities;

import static java.util.Collections.synchronizedList;
import static java.util.concurrent.TimeUnit.MINUTES;
import static io.github.xiaodizi.concurrent.Stage.MUTATION;
import static io.github.xiaodizi.config.CassandraRelevantProperties.NON_GRACEFUL_SHUTDOWN;
 ...
 * {@link io.github.xiaodizi.net.InboundMessageHandler.WaitQueue}, to be reactivated once more permits
 * become available.
 *
 ...
 *
 * See {@link io.github.xiaodizi.metrics.InternodeInboundMetrics} and
 * {@link io.github.xiaodizi.metrics.InternodeOutboundMetrics} for JMX-exposed counters.
 *
 * We also provide {@code system_views.internode_inbound} and {@code system_views.internode_outbound} virtual tables -
 * implemented in {@link io.github.xiaodizi.db.virtual.InternodeInboundTable} and
 * {@link io.github.xiaodizi.db.virtual.InternodeOutboundTable} respectively.
 */
public class MessagingService extends MessagingServiceMBeanImpl
{
    ...
    public <T> io.github.xiaodizi.utils.concurrent.Future<Message<T>> sendWithResult(Message message, InetAddressAndPort to)
    {
