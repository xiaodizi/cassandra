...
import io.github.xiaodizi.diag.store.DiagnosticEventMemoryStore;
import io.github.xiaodizi.diag.store.DiagnosticEventStore;
...
public final class DiagnosticEventPersistence
{
    ...
    private Class<DiagnosticEvent> getEventClass(String eventClazz) throws ClassNotFoundException, InvalidClassException
    {
        ...
        if (!eventClazz.startsWith("io.github.xiaodizi."))
