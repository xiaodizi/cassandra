...
import io.github.xiaodizi.exceptions.AuthenticationException;
...
public interface IAuthenticator
{
     ...
     * @return io.github.xiaodizi.auth.IAuthenticator.SaslNegotiator implementation
     * (see {@link io.github.xiaodizi.auth.PasswordAuthenticator.PlainTextSaslAuthenticator})
     */
    ...
    public interface SaslNegotiator
    {
         ...
         *
         * This method is called each time a {@link io.github.xiaodizi.transport.messages.AuthResponse} is received
         ...
         * {@link io.github.xiaodizi.transport.messages.AuthSuccess} message. If the negotiation is not yet complete,
         * the byte[] is returned to the client as a further challenge in an
         * {@link io.github.xiaodizi.transport.messages.AuthChallenge} message. This continues until the negotiation
