...
import io.github.xiaodizi.concurrent.Shutdownable;
...
import io.github.xiaodizi.metrics.BufferPoolMetrics;
...
import static io.github.xiaodizi.concurrent.InfiniteLoopExecutor.SimulatorSafe.UNSAFE;
import static io.github.xiaodizi.utils.ExecutorUtils.*;
...
import static io.github.xiaodizi.utils.memory.MemoryUtil.isExactlyDirect;
 ...
 * partially freed chunks where some buffers are not released, eg. held by {@link io.github.xiaodizi.cache.ChunkCache}.
