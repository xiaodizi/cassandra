...
package io.github.xiaodizi.utils.logging;
...
public class LoggingSupportFactory
{
    ...
    public static LoggingSupport getLoggingSupport()
    {
        if (loggingSupport == null)
        {
            ...
            {
                loggingSupport = FBUtilities.instanceOrConstruct("io.github.xiaodizi.utils.logging.LogbackLoggingSupport", "LogbackLoggingSupport");
            }
            else
            {
