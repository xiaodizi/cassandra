...
import io.github.xiaodizi.db.compaction.SizeTieredCompactionStrategy;
import io.github.xiaodizi.db.compaction.TimeWindowCompactionStrategy;
...
public final class CompactionParams
{
    ...
    public static Class<? extends AbstractCompactionStrategy> classFromName(String name)
    {
        String className = name.contains(".")
                         ? name
                         : "io.github.xiaodizi.db.compaction." + name;
