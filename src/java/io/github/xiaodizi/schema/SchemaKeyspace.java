...
import io.github.xiaodizi.service.reads.SpeculativeRetryPolicy;
import io.github.xiaodizi.schema.ColumnMetadata.ClusteringOrder;
import io.github.xiaodizi.schema.Keyspaces.KeyspacesDiff;
import io.github.xiaodizi.service.reads.repair.ReadRepairStrategy;
...
import static io.github.xiaodizi.schema.SchemaKeyspaceTables.*;
import static io.github.xiaodizi.utils.Simulate.With.GLOBAL_CLOCK;
...
public final class SchemaKeyspace {
    ...
    public static KeyspaceMetadata metadata() {
        return KeyspaceMetadata.create(SchemaConstants.SCHEMA_KEYSPACE_NAME, KeyspaceParams.local(), io.github.xiaodizi.schema.Tables.of(ALL_TABLE_METADATA));
    }
    ...
    private static Keyspaces fetchKeyspacesWithout(Set<String> excludedKeyspaceNames) {
        ...
        Keyspaces.Builder keyspaces = io.github.xiaodizi.schema.Keyspaces.builder();
    ...
    private static Types fetchTypes(String keyspaceName) {
        ...
        Types.RawBuilder types = io.github.xiaodizi.schema.Types.rawBuilder(keyspaceName);
    ...
    private static Tables fetchTables(String keyspaceName, Types types) {
        ...
        Tables.Builder tables = io.github.xiaodizi.schema.Tables.builder();
        for (UntypedResultSet.Row row : query(query, keyspaceName)) {
    ...
    private static DroppedColumn createDroppedColumnFromRow(UntypedResultSet.Row row) {
         ...
         */
        AbstractType<?> type = CQLTypeParser.parse(keyspace, row.getString("type"), io.github.xiaodizi.schema.Types.none());
    ...
    private static Indexes fetchIndexes(String keyspace, String table) {
        ...
        Indexes.Builder indexes = io.github.xiaodizi.schema.Indexes.builder();
    ...
    private static Triggers fetchTriggers(String keyspace, String table) {
        ...
        Triggers.Builder triggers = io.github.xiaodizi.schema.Triggers.builder();
    ...
    private static Views fetchViews(String keyspaceName, Types types) {
        ...
        Views.Builder views = io.github.xiaodizi.schema.Views.builder();
        for (UntypedResultSet.Row row : query(query, keyspaceName))
    ...
    private static Functions fetchFunctions(String keyspaceName, Types types) {
        ...
        return io.github.xiaodizi.schema.Functions.builder().add(udfs).add(udas).build();
    }
    ...
    private static UDFunction createUDFFromRow(UntypedResultSet.Row row, Types types) {
         ...
         */
        io.github.xiaodizi.cql3.functions.Function existing = Schema.instance.findFunction(name, argTypes).orElse(null);
