...
import io.github.xiaodizi.config.InheritingClass;
import io.github.xiaodizi.config.ParameterizedClass;
import io.github.xiaodizi.db.memtable.Memtable;
import io.github.xiaodizi.db.memtable.SkipListMemtableFactory;
...
public final class MemtableParams
{
    ...
    private static Memtable.Factory getMemtableFactory(ParameterizedClass options)
    {
        ...
        className = className.contains(".") ? className : "io.github.xiaodizi.db.memtable." + className;
        try
        {
