...
import io.github.xiaodizi.cql3.CqlBuilder;
import io.github.xiaodizi.cql3.SchemaElement;
...
import static io.github.xiaodizi.schema.IndexMetadata.isNameValid;
...
public class TableMetadata implements SchemaElement
{
     ...
     *
     * For non-composite types it returns the result of {@link io.github.xiaodizi.cql3.CQL3Type#toCQLLiteral}
     * applied to the partition key.
     * For composite types it applies {@link io.github.xiaodizi.cql3.CQL3Type#toCQLLiteral} to each subkey and
