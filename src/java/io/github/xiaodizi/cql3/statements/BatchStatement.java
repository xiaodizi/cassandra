...
import io.github.xiaodizi.metrics.BatchMetrics;
...
public class BatchStatement implements CQLStatement
{
    ...
    @Override
    public Iterable<io.github.xiaodizi.cql3.functions.Function> getFunctions()
    {
        List<io.github.xiaodizi.cql3.functions.Function> functions = new ArrayList<>();
