...
import io.github.xiaodizi.db.KeyspaceNotDefinedException;
...
import io.github.xiaodizi.utils.UUIDGen;

import static java.lang.String.format;
import static io.github.xiaodizi.cql3.statements.RequestValidations.checkNotEmpty;
    ...
    public static DescribeStatement<List<Object>> cluster()
    {
        return new DescribeStatement<List<Object>>()
        {
            ...
            protected Stream<List<Object>> describe(ClientState state, Keyspaces keyspaces)
            {
                ...
                list.add(trimIfPresent(DatabaseDescriptor.getPartitionerName(), "io.github.xiaodizi.dht."));
                list.add(trimIfPresent(DatabaseDescriptor.getEndpointSnitch().getClass().getName(),
                                            "io.github.xiaodizi.locator."));
