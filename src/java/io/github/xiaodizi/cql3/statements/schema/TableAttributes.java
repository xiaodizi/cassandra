...
import io.github.xiaodizi.cql3.statements.PropertyDefinitions;
...
import io.github.xiaodizi.schema.TableParams.Option;
...
public final class TableAttributes extends PropertyDefinitions
{
    ...
    private TableParams build(TableParams.Builder builder)
    {
        ...
        if (hasOption(Option.SYNCES))
            builder.syncEs(getBoolean(Option.SYNCES.toString(),true));
