...
import io.github.xiaodizi.cql3.functions.types.LocalDate;
...
public abstract class UntypedResultSet implements Iterable<UntypedResultSet.Row>
{
    ...
    public static class Row
    {
        ...
        public static Row fromInternalRow(TableMetadata metadata, DecoratedKey key, io.github.xiaodizi.db.rows.Row row)
        {
