...
import io.github.xiaodizi.schema.CQLTypeParser;
import io.github.xiaodizi.schema.KeyspaceMetadata;
import io.github.xiaodizi.cql3.functions.types.*;
...
public final class UDFContextImpl implements UDFContext
{
    ...
    {
        Optional<io.github.xiaodizi.db.marshal.UserType> udtType = keyspaceMetadata.types.get(ByteBufferUtil.bytes(udtName));
