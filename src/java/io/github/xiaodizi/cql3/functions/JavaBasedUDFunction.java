...
import io.github.xiaodizi.security.SecurityThreadGroup;
...
{
    private static final String BASE_PACKAGE = "io.github.xiaodizi.cql3.udf.gen";
            ...
            if ((i & 1) == 1)
            {
                switch (s)
                {
                    ...
                    case "body":
                        ...
                        s = patternJavaDriver.matcher(body).replaceAll("io.github.xiaodizi.cql3.functions.types.");
                        break;
                    case "arguments":
