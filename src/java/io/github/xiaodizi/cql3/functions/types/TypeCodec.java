...
import io.github.xiaodizi.cql3.functions.types.exceptions.InvalidTypeException;
...
import static io.github.xiaodizi.cql3.functions.types.DataType.*;
...
public abstract class TypeCodec<T>
{
     ...
     * io.github.xiaodizi.db.marshal.AbstractCompositeType}, whose CQL literals are actually
