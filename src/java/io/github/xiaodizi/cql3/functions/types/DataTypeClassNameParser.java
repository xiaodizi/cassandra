 ...
 */
package io.github.xiaodizi.cql3.functions.types;
...
import io.github.xiaodizi.cql3.functions.types.exceptions.DriverInternalError;
import io.github.xiaodizi.cql3.functions.types.utils.Bytes;

/*
 * Parse data types from schema tables, for Cassandra 3.0 and above.
 * In these versions, data types appear as class names, like "io.github.xiaodizi.db.marshal.AsciiType"
 * or "io.github.xiaodizi.db.marshal.TupleType(io.github.xiaodizi.db.marshal.Int32Type,io.github.xiaodizi.db.marshal.Int32Type)".
 *
...
public class DataTypeClassNameParser
{
    ...
    private static final String REVERSED_TYPE = "io.github.xiaodizi.db.marshal.ReversedType";
    private static final String FROZEN_TYPE = "io.github.xiaodizi.db.marshal.FrozenType";
    private static final String LIST_TYPE = "io.github.xiaodizi.db.marshal.ListType";
    private static final String SET_TYPE = "io.github.xiaodizi.db.marshal.SetType";
    private static final String MAP_TYPE = "io.github.xiaodizi.db.marshal.MapType";
    private static final String UDT_TYPE = "io.github.xiaodizi.db.marshal.UserType";
    private static final String TUPLE_TYPE = "io.github.xiaodizi.db.marshal.TupleType";
    private static final String DURATION_TYPE = "io.github.xiaodizi.db.marshal.DurationType";

    private static final ImmutableMap<String, DataType> cassTypeToDataType =
    new ImmutableMap.Builder<String, DataType>()
    .put("io.github.xiaodizi.db.marshal.AsciiType", DataType.ascii())
    .put("io.github.xiaodizi.db.marshal.LongType", DataType.bigint())
    .put("io.github.xiaodizi.db.marshal.BytesType", DataType.blob())
    .put("io.github.xiaodizi.db.marshal.BooleanType", DataType.cboolean())
    .put("io.github.xiaodizi.db.marshal.CounterColumnType", DataType.counter())
    .put("io.github.xiaodizi.db.marshal.DecimalType", DataType.decimal())
    .put("io.github.xiaodizi.db.marshal.DoubleType", DataType.cdouble())
    .put("io.github.xiaodizi.db.marshal.FloatType", DataType.cfloat())
    .put("io.github.xiaodizi.db.marshal.InetAddressType", DataType.inet())
    .put("io.github.xiaodizi.db.marshal.Int32Type", DataType.cint())
    .put("io.github.xiaodizi.db.marshal.UTF8Type", DataType.text())
    .put("io.github.xiaodizi.db.marshal.TimestampType", DataType.timestamp())
    .put("io.github.xiaodizi.db.marshal.SimpleDateType", DataType.date())
    .put("io.github.xiaodizi.db.marshal.TimeType", DataType.time())
    .put("io.github.xiaodizi.db.marshal.UUIDType", DataType.uuid())
    .put("io.github.xiaodizi.db.marshal.IntegerType", DataType.varint())
    .put("io.github.xiaodizi.db.marshal.TimeUUIDType", DataType.timeuuid())
    .put("io.github.xiaodizi.db.marshal.ByteType", DataType.tinyint())
    .put("io.github.xiaodizi.db.marshal.ShortType", DataType.smallint())
