...
import static io.github.xiaodizi.concurrent.SEPExecutor.TakeTaskPermitResult.*;
import static io.github.xiaodizi.concurrent.SEPWorker.Work;
...
public class SEPExecutor implements LocalAwareExecutorPlus, SEPExecutorMBean
{
    ...
    SEPExecutor(SharedExecutorPool pool, int maximumPoolSize, MaximumPoolSizeListener maximumPoolSizeListener, String jmxPath, String name)
    {
        this.pool = pool;
        this.name = name;
        this.mbeanName = "io.github.xiaodizi." + jmxPath + ":type=" + name;
