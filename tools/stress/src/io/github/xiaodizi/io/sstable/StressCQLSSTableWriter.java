...
import io.github.xiaodizi.cql3.statements.schema.CreateTypeStatement;
...
import io.github.xiaodizi.cql3.UpdateParameters;
import io.github.xiaodizi.cql3.functions.UDHelper;
import io.github.xiaodizi.cql3.functions.types.TypeCodec;
import io.github.xiaodizi.cql3.statements.UpdateStatement;
...
public class StressCQLSSTableWriter implements Closeable
{
    ...
    public static class Builder
    {
        ...
        public static ColumnFamilyStore createOfflineTable(CreateTableStatement.Raw schemaStatement, List<CreateTypeStatement.Raw> typeStatements, List<File> directoryList)
        {
            ...
            Directories directories = new Directories(tableMetadata, directoryList.stream().map(f -> new Directories.DataDirectory(new io.github.xiaodizi.io.util.File(f.toPath()))).collect(Collectors.toList()));
