 ...
 *
 */
package io.github.xiaodizi.stress;
...
import io.github.xiaodizi.cql3.statements.ModificationStatement;
...
import io.github.xiaodizi.stress.generate.values.*;
import io.github.xiaodizi.stress.operations.userdefined.CASQuery;
import io.github.xiaodizi.stress.operations.userdefined.SchemaInsert;
import io.github.xiaodizi.stress.operations.userdefined.SchemaQuery;
import io.github.xiaodizi.stress.operations.userdefined.SchemaStatement;
import io.github.xiaodizi.stress.operations.userdefined.TokenRangeQuery;
import io.github.xiaodizi.stress.operations.userdefined.ValidatingSchemaQuery;
import io.github.xiaodizi.stress.report.Timer;
import io.github.xiaodizi.stress.settings.*;
import io.github.xiaodizi.stress.util.JavaDriverClient;
import io.github.xiaodizi.stress.util.ResultLogger;
...
public class StressProfile implements Serializable
{
    ...
    public void maybeCreateSchema(StressSettings settings)
    {
        if (!schemaCreated)
        {
            ...
            if (keyspaceCql != null)
            {
                try
                {
                    client.execute(keyspaceCql, io.github.xiaodizi.db.ConsistencyLevel.ONE);
                }
            ...
            client.execute("use " + keyspaceName, io.github.xiaodizi.db.ConsistencyLevel.ONE);

            if (tableCql != null)
            {
                try
                {
                    client.execute(tableCql, io.github.xiaodizi.db.ConsistencyLevel.ONE);
                }
                catch (AlreadyExistsException e)
                {
                }
            ...
            if (extraSchemaDefinitions != null)
            {
                for (String extraCql : extraSchemaDefinitions)
                {
                    ...
                    try
                    {
                        client.execute(extraCql, io.github.xiaodizi.db.ConsistencyLevel.ONE);
                    }
                    catch (AlreadyExistsException e)
                    {
                    }
    ...
    public void truncateTable(StressSettings settings)
    {
        ...
        client.execute(cql, io.github.xiaodizi.db.ConsistencyLevel.ONE);
    ...
    {
        io.github.xiaodizi.schema.TableMetadata metadata = CreateTableStatement.parse(tableCql, keyspaceName).build();
