 ...
 */
package io.github.xiaodizi.stress.util;
...
public class JavaDriverClient
{
    ...
    public ResultSet execute(String query, io.github.xiaodizi.db.ConsistencyLevel consistency)
    {
    ...
    public ResultSet executePrepared(PreparedStatement stmt, List<Object> queryParams, io.github.xiaodizi.db.ConsistencyLevel consistency)
    {
        if (consistency.isSerialConsistency())
        {
            stmt.setSerialConsistencyLevel(from(consistency));
     ...
     * @return
     */
    public static ConsistencyLevel from(io.github.xiaodizi.db.ConsistencyLevel cl)
    {
        switch (cl)
        {
            case ANY:
