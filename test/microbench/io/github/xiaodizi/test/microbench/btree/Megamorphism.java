...
package io.github.xiaodizi.test.microbench.btree;

import io.github.xiaodizi.utils.BulkIterator;
import io.github.xiaodizi.utils.btree.UpdateFunction;
import io.github.xiaodizi.utils.caching.TinyThreadLocalPool;
...
public class Megamorphism
{
    ...
    static <V> IntFunction<UpdateFunction<V, V>> updateFGetter(boolean keepOld, UpdateF updateF)
    {
        switch (updateF)
        {
