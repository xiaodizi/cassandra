...
import static io.github.xiaodizi.schema.SchemaConstants.*;
...
public class DescribeStatementTest extends CQLTester
{
    ...
    public void testDescribeWithCustomIndex() throws Throwable
    {
        ...
        String indexWithoutOptions = createIndex(KEYSPACE_PER_TEST, "CREATE CUSTOM INDEX ON %s(value) USING 'io.github.xiaodizi.index.sasi.SASIIndex';");
        String indexWithOptions = createIndex(KEYSPACE_PER_TEST, "CREATE CUSTOM INDEX ON %s(value) USING 'io.github.xiaodizi.index.sasi.SASIIndex' WITH OPTIONS = {'is_literal': 'false'};");
        ...
        String expectedIndexStmtWithoutOptions = "CREATE CUSTOM INDEX " + indexWithoutOptions + " ON " + KEYSPACE_PER_TEST + "." + table + " (value) USING 'io.github.xiaodizi.index.sasi.SASIIndex';";
        String expectedIndexStmtWithOptions = "CREATE CUSTOM INDEX " + indexWithOptions + " ON " + KEYSPACE_PER_TEST + "." + table + " (value) USING 'io.github.xiaodizi.index.sasi.SASIIndex' WITH OPTIONS = {'is_literal': 'false'};";
    ...
    private static String tableParametersCql()
    {
        return "additional_write_policy = '99p'\n" +
               ...
               "    AND cdc = false\n" +
               "    AND comment = ''\n" +
               "    AND compaction = {'class': 'io.github.xiaodizi.db.compaction.SizeTieredCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4'}\n" +
               "    AND compression = {'chunk_length_in_kb': '16', 'class': 'io.github.xiaodizi.io.compress.LZ4Compressor'}\n" +
