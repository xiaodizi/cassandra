...
import io.github.xiaodizi.exceptions.PreparedQueryNotFoundException;
import io.github.xiaodizi.index.StubIndex;
import io.github.xiaodizi.serializers.BooleanSerializer;
import io.github.xiaodizi.serializers.Int32Serializer;
...
public class PreparedStatementsTest extends CQLTester
{
        ...
        try (SimpleClient simpleClient = newSimpleClient(ProtocolVersion.BETA.orElse(ProtocolVersion.CURRENT)))
        {
            ...
            prepSelect = verifyMetadataFlagsWithLWTsSelect(simpleClient,
                                                           ...
                                                           Arrays.asList(Int32Serializer.instance.serialize(1),
                                                                         ...
                                                                         Int32Serializer.instance.serialize(20)),
                                                           EnumSet.of(io.github.xiaodizi.cql3.ResultSet.Flag.GLOBAL_TABLES_SPEC));
            ...
            prepSelect = verifyMetadataFlagsWithLWTsSelect(simpleClient,
                                                           ...
                                                           Arrays.asList(Int32Serializer.instance.serialize(1),
                                                                         ...
                                                                         null),
                                                           EnumSet.of(io.github.xiaodizi.cql3.ResultSet.Flag.GLOBAL_TABLES_SPEC,
                                                                      io.github.xiaodizi.cql3.ResultSet.Flag.METADATA_CHANGED));
    ...
    private ResultMessage.Prepared verifyMetadataFlagsWithLWTsSelect(SimpleClient simpleClient,
                                                                     ...
                                                                     EnumSet<io.github.xiaodizi.cql3.ResultSet.Flag> expectedFlags)
    {
        ...
        EnumSet<io.github.xiaodizi.cql3.ResultSet.Flag> resultFlags = rows.result.metadata.getFlags();
        ...
        if (resultFlags.contains(io.github.xiaodizi.cql3.ResultSet.Flag.METADATA_CHANGED))
                                                   ...
                                                   List<ByteBuffer> expectedRow)
    {
        ...
        ResultMessage.Rows rows = (ResultMessage.Rows) result;
        EnumSet<io.github.xiaodizi.cql3.ResultSet.Flag> resultFlags = rows.result.metadata.getFlags();
        assertEquals(EnumSet.of(io.github.xiaodizi.cql3.ResultSet.Flag.GLOBAL_TABLES_SPEC),
                     resultFlags);
        assertEquals(columnNames.size(),
                     rows.result.metadata.getColumnCount());
        assertEquals(columnNames,
