...
import io.github.xiaodizi.auth.RoleOptions;

import static io.github.xiaodizi.cql3.PasswordObfuscator.*;
...
public class PasswordObfuscatorTest
{
    ...
    {
        plainPwdOpts.setOption(io.github.xiaodizi.auth.IRoleManager.Option.PASSWORD, plainPwd);
        hashedPwdOpts.setOption(io.github.xiaodizi.auth.IRoleManager.Option.HASHED_PASSWORD, hashedPwd);
    }
    ...
    public void testPasswordWithNewLinesObfuscation()
    {
        ...
        newLinePassOpts.setOption(io.github.xiaodizi.auth.IRoleManager.Option.PASSWORD, "test\npassword");
        assertEquals(String.format("CREATE USER user1 with PASSWORD '%s'", OBFUSCATION_TOKEN),
    ...
    public void testEmptyPasswordObfuscation()
    {
        ...
        emptyPassOpts.setOption(io.github.xiaodizi.auth.IRoleManager.Option.PASSWORD, "");
