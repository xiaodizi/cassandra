...
import io.github.xiaodizi.cql3.functions.UDFByteCodeVerifier;
import io.github.xiaodizi.cql3.validation.entities.udfverify.*;
...
public class UFVerifierTest extends CQLTester
{
    ...
    {
        assertEquals(new HashSet<>(Collections.singletonList("call to io.github.xiaodizi.config.DatabaseDescriptor.getClusterName()")),
