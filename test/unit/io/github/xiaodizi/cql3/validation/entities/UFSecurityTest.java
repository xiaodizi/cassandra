...
public class UFSecurityTest extends CQLTester
{
    ...
    public void testSecurityPermissions() throws Throwable
    {
        ...
        {"io.github.xiaodizi.service.StorageService",
         "try {" +
         "     io.github.xiaodizi.service.StorageService v = io.github.xiaodizi.service.StorageService.instance; v.isShutdown(); return 0d;" +
         "} catch (Exception t) {" +
         "     throw new RuntimeException(t);" +
         '}'},
        ...
        try
        {
            String fName = createFunction(KEYSPACE_PER_TEST, "double",
                                          ...
                                          "RETURNS double " +
                                          "LANGUAGE javascript\n" +
                                          "AS 'io.github.xiaodizi.service.StorageService.instance.isShutdown(); 0;';");
            execute("SELECT " + fName + "(dval) FROM %s WHERE key=1");
