...
public class ResourcesTest
{
    ...
    public void testFunctionResourceNameConversion()
    {
        ...
        assertEquals(FunctionResource.function("ks1", "f1", Arrays.asList(Int32Type.instance, DoubleType.instance)),
                Resources.fromName("functions/ks1/f1[io.github.xiaodizi.db.marshal.Int32Type^io.github.xiaodizi.db.marshal.DoubleType]"));
        assertEquals("functions/ks1/f1[io.github.xiaodizi.db.marshal.Int32Type^io.github.xiaodizi.db.marshal.DoubleType]",
    ...
    public void testJMXResourceNameConversion()
    {
        ...
        assertEquals(JMXResource.mbean("io.github.xiaodizi.auth:type=*"),
                Resources.fromName("mbean/io.github.xiaodizi.auth:type=*"));
        assertEquals("mbean/io.github.xiaodizi.auth:type=*",
                JMXResource.mbean("io.github.xiaodizi.auth:type=*").getName());
    }
}
