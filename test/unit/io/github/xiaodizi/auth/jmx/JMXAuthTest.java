...
package io.github.xiaodizi.auth.jmx;
...
public class JMXAuthTest extends CQLTester
{
    ...
    public void setup() throws Throwable
    {
        ...
        tableMBean = JMXResource.mbean(String.format("io.github.xiaodizi.db:type=Tables,keyspace=%s,table=%s",
                                                     KEYSPACE, tableName));
    }
    ...
    public void readAttribute() throws Throwable
    {
        ...
        clearAllPermissions();
        JMXResource allTablesInKeyspace = JMXResource.mbean(String.format("io.github.xiaodizi.db:type=Tables,keyspace=%s,*",
                                                                          KEYSPACE));
        assertPermissionOnResource(Permission.SELECT, allTablesInKeyspace, proxy::getTableName);

        // grant SELECT on all Table mbeans
        clearAllPermissions();
        JMXResource allTables = JMXResource.mbean("io.github.xiaodizi.db:type=Tables,*");
