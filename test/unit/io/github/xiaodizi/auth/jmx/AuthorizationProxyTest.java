...
public class AuthorizationProxyTest
{
    ...
    JMXResource hintsBean = JMXResource.mbean("io.github.xiaodizi.hints:type=HintsService");
    JMXResource batchlogBean = JMXResource.mbean("io.github.xiaodizi.db:type=BatchlogManager");
    ...
    public void rejectWhenWildcardGrantIntersectsWithWildcardTarget() throws Throwable
    {
        ...
        // and all beans in the io.github.xiaodizi.hints domain, but
        ...
        JMXResource allHintsBeans = JMXResource.mbean("io.github.xiaodizi.hints:*");
