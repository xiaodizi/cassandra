...
public class FBUtilitiesTest
{
    ...
    public void testNewPartitionerNoArgConstructors()
    {
        ...
        assertPartitioner("io.github.xiaodizi.dht.ByteOrderedPartitioner", ByteOrderedPartitioner.class);
        assertPartitioner("io.github.xiaodizi.dht.LengthPartitioner", LengthPartitioner.class);
        assertPartitioner("io.github.xiaodizi.dht.Murmur3Partitioner", Murmur3Partitioner.class);
        assertPartitioner("io.github.xiaodizi.dht.OrderPreservingPartitioner", OrderPreservingPartitioner.class);
        assertPartitioner("io.github.xiaodizi.dht.RandomPartitioner", RandomPartitioner.class);
    }
    ...
    {
        for (String name : new String[] {"LocalPartitioner", "io.github.xiaodizi.dht.LocalPartitioner"})
