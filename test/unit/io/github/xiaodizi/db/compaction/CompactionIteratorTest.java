...
import static io.github.xiaodizi.db.transform.DuplicateRowCheckerTest.assertCommandIssued;
import static io.github.xiaodizi.db.transform.DuplicateRowCheckerTest.makeRow;
import static io.github.xiaodizi.db.transform.DuplicateRowCheckerTest.rows;
...
public class CompactionIteratorTest extends CQLTester
{
    ...
    // See io.github.xiaodizi.db.rows.UnfilteredRowsGenerator.parse for the syntax used in these tests.
