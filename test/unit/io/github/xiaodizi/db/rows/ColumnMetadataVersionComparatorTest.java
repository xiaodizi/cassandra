...
import static io.github.xiaodizi.cql3.FieldIdentifier.forUnquoted;
...
public class ColumnMetadataVersionComparatorTest
{
    ...
    {
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type io.github.xiaodizi.db.marshal.Int32Type and one of type io.github.xiaodizi.db.marshal.UTF8Type (but both types are incompatible)",
                                Int32Type.instance,
                                UTF8Type.instance);
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type io.github.xiaodizi.db.marshal.FrozenType(io.github.xiaodizi.db.marshal.UserType(ks,6d7954797065,61:io.github.xiaodizi.db.marshal.Int32Type,62:io.github.xiaodizi.db.marshal.Int32Type)) and one of type io.github.xiaodizi.db.marshal.Int32Type (but both types are incompatible)",
                                udtWith2Fields,
                                Int32Type.instance);
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type io.github.xiaodizi.db.marshal.SetType(io.github.xiaodizi.db.marshal.UTF8Type) and one of type io.github.xiaodizi.db.marshal.SetType(io.github.xiaodizi.db.marshal.InetAddressType) (but both types are incompatible)",
                                SetType.getInstance(UTF8Type.instance, true),
                                SetType.getInstance(InetAddressType.instance, true));
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type io.github.xiaodizi.db.marshal.ListType(io.github.xiaodizi.db.marshal.UTF8Type) and one of type io.github.xiaodizi.db.marshal.ListType(io.github.xiaodizi.db.marshal.InetAddressType) (but both types are incompatible)",
                                ListType.getInstance(UTF8Type.instance, true),
                                ListType.getInstance(InetAddressType.instance, true));
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type io.github.xiaodizi.db.marshal.MapType(io.github.xiaodizi.db.marshal.UTF8Type,io.github.xiaodizi.db.marshal.IntegerType) and one of type io.github.xiaodizi.db.marshal.MapType(io.github.xiaodizi.db.marshal.InetAddressType,io.github.xiaodizi.db.marshal.IntegerType) (but both types are incompatible)",
        ...
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type io.github.xiaodizi.db.marshal.MapType(io.github.xiaodizi.db.marshal.IntegerType,io.github.xiaodizi.db.marshal.UTF8Type) and one of type io.github.xiaodizi.db.marshal.MapType(io.github.xiaodizi.db.marshal.IntegerType,io.github.xiaodizi.db.marshal.InetAddressType) (but both types are incompatible)",
