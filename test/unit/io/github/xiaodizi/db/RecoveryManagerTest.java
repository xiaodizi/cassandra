...
import io.github.xiaodizi.db.commitlog.CommitLogArchiver;
import io.github.xiaodizi.db.commitlog.CommitLogReplayer;
...
public class RecoveryManagerTest
{
    ...
    private static class MockInitiator extends CommitLogReplayer.MutationInitiator
    {
        ...
        @Override
        protected io.github.xiaodizi.utils.concurrent.Future<Integer> initiateMutation(final Mutation mutation,
                                                                                         final long segmentId,
                                                                                         final int serializedSize,
                                                                                         final int entryLocation,
                                                                                         final CommitLogReplayer clr)
        {
            final io.github.xiaodizi.utils.concurrent.Future<Integer> toWrap =
