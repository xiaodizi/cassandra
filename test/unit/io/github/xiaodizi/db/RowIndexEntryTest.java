...
import io.github.xiaodizi.db.columniterator.AbstractSSTableIterator;
...
import io.github.xiaodizi.db.rows.RangeTombstoneMarker;
import io.github.xiaodizi.db.rows.Row;
import io.github.xiaodizi.db.rows.SerializationHelper;
import io.github.xiaodizi.db.rows.Unfiltered;
import io.github.xiaodizi.db.rows.UnfilteredRowIterator;
import io.github.xiaodizi.db.rows.UnfilteredSerializer;
...
import io.github.xiaodizi.serializers.LongSerializer;
...
public class RowIndexEntryTest extends CQLTester
{
    ...
    private static class DoubleSerializer implements AutoCloseable
    {
        ...
        final io.github.xiaodizi.db.ColumnIndex columnIndex;
        ...
        DoubleSerializer() throws IOException
        {
            ...
            columnIndex = new io.github.xiaodizi.db.ColumnIndex(header, dataWriterNew, version, Collections.emptyList(),
