...
import static io.github.xiaodizi.utils.ByteBufferUtil.toInt;
...
public class TriggersTest
{
    ...
    @Test(expected=io.github.xiaodizi.exceptions.InvalidRequestException.class)
    ...
    public static class ErrorTrigger implements ITrigger
    {
        ...
        public Collection<Mutation> augment(Partition partition)
        {
            throw new io.github.xiaodizi.exceptions.InvalidRequestException(MESSAGE);
        }
    }
}
