...
import static io.github.xiaodizi.config.EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.all;
import static io.github.xiaodizi.config.EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.dc;
import static io.github.xiaodizi.config.EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.none;
import static io.github.xiaodizi.config.EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.rack;
import static io.github.xiaodizi.config.EncryptionOptions.TlsEncryptionPolicy.ENCRYPTED;
import static io.github.xiaodizi.config.EncryptionOptions.TlsEncryptionPolicy.OPTIONAL;
...
public class EncryptionOptionsTest
{
    static class EncryptionOptionsTestCase
    {
        ...
        {
            return new EncryptionOptionsTestCase(new EncryptionOptions(new ParameterizedClass("io.github.xiaodizi.security.DefaultSslContextFactory",
                                                                                              new HashMap<>()),
    ...
    static class ServerEncryptionOptionsTestCase
    {
        ...
        public static ServerEncryptionOptionsTestCase of(Boolean optional, String keystorePath,
                                                         ...
                                                         EncryptionOptions.TlsEncryptionPolicy expected)
        {
            return new ServerEncryptionOptionsTestCase(new EncryptionOptions.ServerEncryptionOptions(new ParameterizedClass("io.github.xiaodizi.security.DefaultSslContextFactory",
