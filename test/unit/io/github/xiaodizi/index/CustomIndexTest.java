...
import io.github.xiaodizi.cql3.restrictions.IndexRestrictions;
...
import static io.github.xiaodizi.cql3.statements.schema.IndexTarget.CUSTOM_INDEX_OPTION_NAME;
...
public class CustomIndexTest extends CQLTester
{
    ...
    public void testInsertsOnCfsBackedIndex() throws Throwable
    {
        ...
        createIndex("CREATE CUSTOM INDEX ON %s(c) USING 'io.github.xiaodizi.index.internal.CustomCassandraIndex'");
    ...
    public void testTruncateWithNonCfsCustomIndex() throws Throwable
    {
        ...
        createIndex("CREATE CUSTOM INDEX ON %s(b) USING 'io.github.xiaodizi.index.StubIndex'");
    ...
    public void testFailing2iFlush() throws Throwable
    {
        ...
        createIndex("CREATE CUSTOM INDEX IF NOT EXISTS ON %s(value) USING 'io.github.xiaodizi.index.CustomIndexTest$BrokenCustom2I'");
