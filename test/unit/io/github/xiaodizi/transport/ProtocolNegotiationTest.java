...
import io.github.xiaodizi.exceptions.TransportException;
import io.github.xiaodizi.transport.messages.OptionsMessage;
import io.github.xiaodizi.transport.messages.QueryMessage;
import io.github.xiaodizi.transport.messages.StartupMessage;
...
import static io.github.xiaodizi.transport.messages.StartupMessage.CQL_VERSION;
...
public class ProtocolNegotiationTest extends CQLTester
{
                                ...
                                com.datastax.driver.core.ProtocolVersion expectedVersion)
    {
        ...
        {
            if (requestedVersion.toInt() > io.github.xiaodizi.transport.ProtocolVersion.CURRENT.asInt())
