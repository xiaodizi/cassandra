...
import static io.github.xiaodizi.Util.spinAssertEquals;
import static io.github.xiaodizi.transport.ProtocolVersion.V4;
...
public class RateLimitingTest extends CQLTester
{
    ...
    {
        String metricName = "io.github.xiaodizi.metrics.Client.RequestDispatched";
