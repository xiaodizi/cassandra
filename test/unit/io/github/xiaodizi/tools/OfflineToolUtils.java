...
import static io.github.xiaodizi.utils.FBUtilities.preventIllegalAccessWarnings;
...
public abstract class OfflineToolUtils
{
    ...
    {
        assertClassNotLoaded("io.github.xiaodizi.schema.Schema");
    }

    public void assertSchemaLoaded()
    {
        assertClassLoaded("io.github.xiaodizi.schema.Schema");
    }

    public void assertKeyspaceNotLoaded()
    {
        assertClassNotLoaded("io.github.xiaodizi.db.Keyspace");
    }

    public void assertKeyspaceLoaded()
    {
        assertClassLoaded("io.github.xiaodizi.db.Keyspace");
    }

    public void assertServerNotLoaded()
    {
        assertClassNotLoaded("io.github.xiaodizi.transport.Server");
    }

    public void assertSystemKSNotLoaded()
    {
        assertClassNotLoaded("io.github.xiaodizi.db.SystemKeyspace");
    }

    public void assertCLSMNotLoaded()
    {
        assertClassNotLoaded("io.github.xiaodizi.db.commitlog.CommitLogSegmentManager");
    }
    ...
    {
        System.setProperty("cassandra.partitioner", "io.github.xiaodizi.dht.Murmur3Partitioner");
