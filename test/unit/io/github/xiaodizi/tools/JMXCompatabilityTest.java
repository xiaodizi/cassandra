...
import io.github.xiaodizi.service.CassandraDaemon;
import io.github.xiaodizi.service.GCInspector;
import io.github.xiaodizi.tools.ToolRunner.ToolResult;
...
public class JMXCompatabilityTest extends CQLTester
{
    ...
    {
        List<String> excludeObjects = Arrays.asList("io.github.xiaodizi.metrics:type=ThreadPools.*",
                                                    "io.github.xiaodizi.internal:.*",
                                                    "io.github.xiaodizi.metrics:type=DroppedMessage.*",
                                                    "io.github.xiaodizi.metrics:type=ClientRequest,scope=CASRead,name=ConditionNotMet",
                                                    "io.github.xiaodizi.metrics:type=Client,name=connectedThriftClients", // removed in CASSANDRA-11115
                                                    "io.github.xiaodizi.request:type=ReadRepairStage", // removed in CASSANDRA-13910
                                                    "io.github.xiaodizi.db:type=HintedHandoffManager", // removed in CASSANDRA-15939

                                                    // dropped tables
                                                    "io.github.xiaodizi.metrics:type=Table,keyspace=system,scope=(schema_aggregates|schema_columnfamilies|schema_columns|schema_functions|schema_keyspaces|schema_triggers|schema_usertypes),name=.*",
    ...
    {
        List<String> excludeObjects = Arrays.asList("io.github.xiaodizi.metrics:type=ThreadPools.*", //lazy initialization in 4.0
                                                    "io.github.xiaodizi.internal:.*",
                                                    "io.github.xiaodizi.metrics:type=DroppedMessage,scope=PAGED_RANGE.*", //it was deprecated in the previous major version
                                                    "io.github.xiaodizi.metrics:type=Client,name=connectedThriftClients", // removed in CASSANDRA-11115
                                                    "io.github.xiaodizi.request:type=ReadRepairStage", // removed in CASSANDRA-13910
                                                    "io.github.xiaodizi.db:type=HintedHandoffManager", // removed in CASSANDRA-15939
