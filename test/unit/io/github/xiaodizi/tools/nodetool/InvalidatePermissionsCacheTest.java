...
import io.github.xiaodizi.auth.FunctionResource;
...
import io.github.xiaodizi.auth.JMXResource;
...
import static io.github.xiaodizi.auth.AuthTestUtils.ROLE_A;
import static io.github.xiaodizi.auth.AuthTestUtils.ROLE_B;
import static io.github.xiaodizi.auth.AuthTestUtils.getRolePermissionsReadCount;
...
public class InvalidatePermissionsCacheTest extends CQLTester
{
    ...
    public static void setup() throws Exception
    {
        ...
        List<IResource> resources = Arrays.asList(
                ...
                JMXResource.root(),
                JMXResource.mbean("io.github.xiaodizi.auth:type=*"));
    ...
    public void testInvalidatePermissionsWithIncorrectParameters()
    {
        ...
        assertThat(tool.getExitCode()).isEqualTo(1);
        assertThat(tool.getStdout())
                .isEqualTo(wrapByDefaultNodetoolMessage("An error was encountered when looking up function definition: Unable to find abstract-type class 'io.github.xiaodizi.db.marshal.x'"));
        assertThat(tool.getStderr()).isEmpty();
    }
    ...
    public void testInvalidatePermissionsForEveryResourceExceptFunction()
    {
        ...
        assertInvalidation(JMXResource.mbean("io.github.xiaodizi.auth:type=*"),
                Arrays.asList("--mbean", "io.github.xiaodizi.auth:type=*"));
    }
