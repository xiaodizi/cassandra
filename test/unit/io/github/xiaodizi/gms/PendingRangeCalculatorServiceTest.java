...
public class PendingRangeCalculatorServiceTest
{
    ...
    @BMRule(name = "Block pending range calculation",
            ...
            targetLocation = "AT INVOKE io.github.xiaodizi.locator.AbstractReplicationStrategy.getAddressReplicas",
            action = "io.github.xiaodizi.gms.PendingRangeCalculatorServiceTest.calculationLock.lock()")
