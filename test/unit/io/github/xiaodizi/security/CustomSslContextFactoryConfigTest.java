...
public class CustomSslContextFactoryConfigTest
{
    ...
    public void testValidCustomSslContextFactoryConfiguration() {
        ...
        Assert.assertEquals("io.github.xiaodizi.security.DummySslContextFactoryImpl",
    ...
    public void testInvalidCustomSslContextFactoryConfiguration() {
        ...
        try {
            ...
            Assert.assertEquals("Unable to create instance of ISslContextFactory for io.github.xiaodizi.security" +
