...
import io.github.xiaodizi.simulator.systems.InterceptedExecution.InterceptedFutureTaskExecution;
import io.github.xiaodizi.simulator.systems.InterceptedExecution.InterceptedThreadStart;
import io.github.xiaodizi.simulator.systems.InterceptingExecutor.InterceptedScheduledFutureTask;
...
public class SimulatedExecution implements InterceptorOfExecution
{
    ...
    public InterceptExecution intercept()
    {
        ...
        return new Intercept(interceptibleThread);
    }
