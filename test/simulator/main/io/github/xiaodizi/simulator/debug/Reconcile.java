...
public class Reconcile
{
    ...
    public static class RandomSourceReconciler extends RandomSource.Abstract implements Supplier<RandomSource>, Closeable
    {
        ...
        private static final AtomicReferenceFieldUpdater<RandomSourceReconciler, Thread> lockedUpdater = AtomicReferenceFieldUpdater.newUpdater(RandomSourceReconciler.class, Thread.class, "locked");
        final DataInputPlus in;
