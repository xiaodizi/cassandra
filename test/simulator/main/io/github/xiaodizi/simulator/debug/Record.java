...
package io.github.xiaodizi.simulator.debug;

import io.github.xiaodizi.io.util.BufferedDataOutputStreamPlus;
import io.github.xiaodizi.io.util.DataOutputStreamPlus;
...
import io.github.xiaodizi.simulator.SimulationRunner.RecordOption;
...
import static io.github.xiaodizi.simulator.SimulationRunner.RecordOption.*;
...
public class Record
{
    ...
    {
        private static final AtomicReferenceFieldUpdater<RandomSourceRecorder, Thread> lockedUpdater = AtomicReferenceFieldUpdater.newUpdater(RandomSourceRecorder.class, Thread.class, "locked");
